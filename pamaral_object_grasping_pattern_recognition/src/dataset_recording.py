...
rospy.wait_for_service('/mediapipe_camera/start_capture')
rospy.wait_for_service('/mediapipe_camera/stop_capture')
...
rosbag_cmd = ['rosbag', 'record', '-j', '-O', filename, 'mediapipe_camera/color/image_raw']
...
service_proxy = rospy.ServiceProxy('/mediapipe_camera/start_capture', Empty)
...
service_proxy = rospy.ServiceProxy('/mediapipe_camera/stop_capture', Empty)
